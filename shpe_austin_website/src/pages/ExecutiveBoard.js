...
const board = [
  {
    ...
    whyShpe: 'I am extremely passionate about supporting my fellow STEM Hispanic Familia. I hope to assist all aspiring engineers become strong leaders while also advancing community outreach initiatives.',
  ...
  },
  {
    ...
    funFact: 'Outside of work, I love staying active, exploring the local food scene, and relaxing with a great book.',
    whyShpe: 'My journey with SHPE spans 15 years, including deep involvement with the SHPE National Convention and driving diversity through SHPE Pride. I joined SHPE Austin to bring that lifelong passion for our community to the local level, helping to create a strong, welcoming space where we can lift each other up and grow together.',
